...
#define print_one(x) _Generic((x), \
    ...
    char: print_char, \
    char*: print_string, \
    const signed char: print_i64, \
    const short: print_i64, \
    const int: print_i64, \
    const long: print_i64,   \
    const long long: print_i64, \
    const unsigned char: print_i64, \
    const unsigned short: print_u64, \
    const unsigned int: print_u64, \
    const unsigned long: print_u64, \
    const unsigned long long: print_u64, \
